...
<head>
    ...
    <link rel="stylesheet" href="css/Poin_Rewards.css">
...
<body>
    <header class="header">
        ...
        <nav>
            ...
            <a href="misi.html">Mission</a>
            <a href="#" class="active">Poin Rewards</a>
            <a href="cekprofile.html"><img src="assets/Me.jpg" alt="Profile" width="40" height="40"></a>
        </nav>
    </header>

    <main class="main-content">
        <div class="points-banner">
            <p>Hi Bambang Pamungkas, Poin Anda</p>
            <p class="points">10.000 Poin <span class="star">⭐</span></p>
        </div>
